...
class AwarenessRuntime:
            ...
            try:
                ...
                event_result = emit_event(
                    "desktop.changed",
                    {
                        "screen": screen,
                        "ui": ui,
                        "previous_ui": (previous_state or {}).get("ui"),
    ...
    def state(self):
        with self._lock:
            data = {"enabled": self.enabled, "last_state": self._last_state,
                    "sample_count": self._sample_count, "change_count": self._change_count,
                    "last_sample": self._last_sample, "last_change": self._last_change}
